          ...
          <AppBar position="static">
            <Toolbar>
              <IconButton
                ...
                sx={{ mr: 2 }}>
                <Link to="/" className="İconLinks">
                  <IoMdHome className="İconLinks" />
                </Link>
              </IconButton>
              ...
              <Box sx={{ display: { xs: "none", md: "flex" } }}>
                ...
                <IconButton
                  ...
                  color="inherit">
                  <Badge badgeContent={favoritesCount} color="error">
                    <Link to="/Favorites" className="İconLinks">
                      <IoIosHeart className="İconLinks" />
                    </Link>
                  </Badge>
                </IconButton>
                <IconButton
                  ...
                  <Badge
                    ...
                    color="error">
                    <Link to="/cart" className="İconLinks">
                      <FaShoppingCart className="İconLinks" />
                    </Link>
                  </Badge>
                </IconButton>
              </Box>
