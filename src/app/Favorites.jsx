...
const Favorites = ({ product, total, money, basket, setBasket, value }) => {
  ...
  return (
    <>
      ...
      <div className="FavTitle">
        <h6 className="mbbb-0">
          Pasta favorita <IoIosHeart className="FavHeart" />
        </h6>
        <div className="FavİtemCount">
          <span>Hai {favoritesCount} elementi tra i preferiti</span>
